...
<body>
                            ...
                            <form method="post" enctype="multipart/form-data">
                                <div class="card-body media align-items-center">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input" name="firstName" value="<?php echo $_SESSION['firstname'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Last name</label>
                                        <input type="text" class="form-control input" name="lastName" value="<?php echo $_SESSION['lastname'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">E-mail</label>
                                        <input type="text" class="form-control input" name="email" value="<?php echo $_SESSION['email'] ?>">
                                    </div>
                                </div>
                                <!-- Save and Cancel buttons for General section -->
                                <div class="text-right mt-3">
                                    <button type="submit" class="profile-button type2" name="update_general">Save changes</button>&nbsp;
                                    <button type="button" class="profile-button type2" name="cancel">Cancel</button>
                                </div>
                            </form>
                        </div>
    ...
    <?php endif; ?>
                                ...
                                <div class="text-right mt-3">
                                    <button type="submit" name="change_password" class="profile-button type2">Save changes</button>&nbsp;
                                    <button type="button" class="profile-button type2" name="cancel">Cancel</button>
                                </div>
                            </form>
                        </div>
                            ...
                            <form method="post">
                                <div class="card-body pb-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="Result" class="form-control input" rows="5">
                                            <?php
        ...
        <a class="exit-icon" href="/pythonprojects/Web project/index.php">
    <img class="exit-icon exit-icon-special" src="images/icons8-back-80.png" alt="">
</a>
        <a class="" href="profile-ar.php"><img class="translate" src="images/augmented-reality.png" alt=""></a>
    </div>
    ...
    <script src="https://www.chatbase.co/embed.min.js" chatbotId="v1C8-dshFH1HTUSozu7ir" domain="www.chatbase.co" defer></script>
</body>
</html>
